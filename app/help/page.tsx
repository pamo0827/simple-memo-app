  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <p className="text-gray-600 mb-8">Cook-Bookの使い方を説明します。レシピだけでなく、SNSの投稿や動画の内容保存にも活用できます。</p>
        ...
        <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-3 text-sm">
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                    <li><strong>X（旧Twitter）</strong> - ツイート内容を抽出</li>
                    <li><strong>Instagram</strong> - 画像を解析して内容を抽出</li>
          ...
          <Card className="border-blue-200 bg-blue-50">
            ...
            <CardContent className="space-y-2 text-sm text-blue-900">
              ...
              <p>• XやInstagram、YouTubeの内容も簡単に保存できます</p>
